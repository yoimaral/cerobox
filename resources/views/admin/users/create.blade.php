                    ...
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="observation"
                                class="col-md-4 col-form-label text-md-right">{{ __('Observation') }}</label>

                            <div class="col-md-6">
                                <input id="observation" type="text"
                                    class="form-control @error('observation') is-invalid @enderror"
                                    observation="observation" value="{{ old('observation') }}" required
                                    autocomplete="observation" autofocus>
